...
const alignmentKeys = new Map([
  ...
  ["initium", "introductio"],
  ["mysteres joyeux", "mysteria-gaudiosa"],
  ["mysteria gaudiosa", "mysteria-gaudiosa"],
  ["mysteres douloureux", "mysteria-dolorosa"],
  ["mysteria dolorosa", "mysteria-dolorosa"],
  ["mysteres glorieux", "mysteria-gloriosa"],
  ["mysteria gloriosa", "mysteria-gloriosa"],
  ["decennie", "decas"],
  ["decas", "decas"],
  ["priere finale", "oratio-finalis"],
  ["oratio finalis", "oratio-finalis"],
  ["oraison", "oratio"],
  ["prions", "oratio"],
  ["oratio", "oratio"],
  ["oremus", "oratio"]
...
function renderVirtualRosary() {
  return `        <div class="virtual-rosary" data-virtual-rosary>
          ...
          <button class="virtual-rosary-stage" type="button" data-rosary-stage aria-label="Avancer dans le chapelet">
            <svg class="virtual-rosary-svg" viewBox="0 0 760 360" role="img" aria-label="Chapelet interactif" focusable="false" data-rosary-svg></svg>
          </button>
